...
public class RSACoder {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("公钥1：/n" + Base64.encodeBase64String(publicKey1));
        System.out.println("私钥1：/n" + Base64.encodeBase64String(privateKey1));
        System.out.println("公钥2：/n" + Base64.encodeBase64String(publicKey2));
        System.out.println("私钥2：/n" + Base64.encodeBase64String(privateKey2));
        ...
        //乙方使用公钥对数据进行加密
        byte[] code2 = RSACoder.encryptByPrivateKey(str.getBytes(), privateKey2);
//        byte[] code2 = RSACoder.encryptByPublicKey(str.getBytes(), privateKey);
        ...
        //甲方使用私钥对数据进行解密
        byte[] decode2 = RSACoder.decryptByPublicKey(code2, publicKey2);
