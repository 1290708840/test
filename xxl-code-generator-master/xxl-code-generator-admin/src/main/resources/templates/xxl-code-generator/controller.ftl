...
*
* Created by lixiang on '${.now?string('yyyy-MM-dd HH:mm:ss')}'.
*/
@Controller
public class ConfController {
    ...
    */
    ...
    @ResponseBody
    public ReturnT<String> delete(@RequestBody Map<String, String> map){
    ...
    */
    @RequestMapping("/load")
    @ResponseBody
    public ReturnT<String> load(@RequestBody Map<String, String> map){
